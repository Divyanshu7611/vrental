      ...
      <main className="container mx-auto px-4 py-16 md:px-8 md:py-20">
        ...
        <section className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <p className="text-gray-700 mb-4">
            ...
            the property. Misrepresentation of any kind will lead to removal of
            the listing.
          </p>
          ...
          <p className="text-gray-700 mb-4">
            Illegal properties, sublets without authorization, or properties
            that violate local housing rules cannot be posted.
          </p>
