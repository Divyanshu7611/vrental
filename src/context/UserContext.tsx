...
//   profession: string;
//   bio: string;
//   wishlist: string[]; // Add this line for wishlist
// }
...
//   setHandleForm: (value: boolean) => void;
//   wishlist: string[];
//   addToWishlist: (apartmentId: string) => void;
...
//   const addToWishlist = (apartmentId: string) => {
//     if (!wishlist.includes(apartmentId)) {
//       const updatedWishlist = [...wishlist, apartmentId];
...
//     const updatedWishlist = wishlist.filter((id) => id !== apartmentId);
//     setWishlist(updatedWishlist);
//     localStorage.setItem("wishlist", JSON.stringify(updatedWishlist));
